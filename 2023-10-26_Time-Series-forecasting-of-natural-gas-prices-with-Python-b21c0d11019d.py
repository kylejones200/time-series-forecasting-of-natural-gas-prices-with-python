...
def main_step_002(S0, daily_returns, df, intervals, iterations, logger, pred_end_date, price_list, ticker) -> None:
...
def the_histogram_of_the_data(S0, mu, num_bins, pred_end_date, sigma, ticker, x) -> None:
    fig, ax = plt.subplots()
...
def head() -> None:
    ...
    price_list[0] = S0
    main_step_002(S0, daily_returns, df, intervals, iterations, logger, pred_end_date, price_list, ticker)
